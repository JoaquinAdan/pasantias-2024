...
export default function Header(){
    ...
    return(
        <header className={`hidden lg:flex justify-between w-screen sticky top-0 p-5 border-b border-slate-100 drop-shadow-sm transition-colors duration-300 ${isScrolled ? " backdrop-blur-md" : "bg-slate-100"}`} style={{ zIndex: 9999 }}>
