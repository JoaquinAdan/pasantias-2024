...
export default function LocalizacionSection() {
    ...
    return (
        <div id="localizacion" className="bg-violet-200 flex-col border-2 border-violet-900 rounded-xl p-4">
            ...
            <h4 className="text-center w860:text-left italic">Arrastre el ícono de ubicación (azul) hacia su calle y altura aproximada, o hacia la calle y entre calles de destino.</h4>
            <Controller 
                name="Coordenadas"
                control={control}
                render={({_}) => (
